...
local({
  ...
  app <- shinytest2::AppDriver$new(dv.modules.bsafe:::mock_decision_making_mod())
...
local({
  ...
  app <- shinytest2::AppDriver$new(dv.modules.bsafe:::mock_decision_making_mod(BSAFE_CHOICES$SEL_ANALYSIS[2]))
