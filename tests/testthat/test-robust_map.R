...
local({
  ...
  app <- shinytest2::AppDriver$new(dv.modules.bsafe:::mock_robust_map_mod())
  ...
  app <- shinytest2::AppDriver$new(dv.modules.bsafe:::mock_robust_map_mod(BSAFE_CHOICES$SEL_ANALYSIS[2]))
