...
local({
  ...
  app <- shinytest2::AppDriver$new(dv.modules.bsafe:::mock_new_trial_analysis_mod())
  ...
  app <- shinytest2::AppDriver$new(dv.modules.bsafe:::mock_new_trial_analysis_mod(BSAFE_CHOICES$SEL_ANALYSIS[2]))
